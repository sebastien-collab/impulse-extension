...
(function() {
  ...
  function scanTechStack() {
    ...
    var techPatterns = [
      ...
      // CMS (additional)
      { name: 'Drupal', category: 'cms', color: '#0678BE', icon: 'Dr',
        metaName: 'generator', metaMatch: /drupal/i, scriptMatch: /drupal\.js|\/sites\/default\/files/i },
      { name: 'Joomla', category: 'cms', color: '#5091CD', icon: 'Jm',
        metaName: 'generator', metaMatch: /joomla/i, scriptMatch: /\/media\/jui\/js|joomla/i },
      { name: 'Ghost', category: 'cms', color: '#15171A', icon: 'Gh',
        metaName: 'generator', metaMatch: /ghost/i, scriptMatch: /ghost\.io|ghost\/portal/i },
      { name: 'Hugo', category: 'cms', color: '#FF4088', icon: 'Hu',
        metaName: 'generator', metaMatch: /hugo/i },
      // Analytics
      { name: 'Matomo', category: 'analytics', color: '#3152A0', icon: 'Mt',
        scriptMatch: /matomo\.js|piwik\.js/i },
      { name: 'Adobe Analytics', category: 'analytics', color: '#EB1000', icon: 'AA',
        scriptMatch: /omtrdc\.net|adoberesources\.net/i },
      { name: 'Mixpanel', category: 'analytics', color: '#7856FF', icon: 'Mp',
        scriptMatch: /cdn\.mxpnl\.com|mixpanel/i },
      { name: 'Amplitude', category: 'analytics', color: '#1E61F0', icon: 'Am',
        scriptMatch: /cdn\.amplitude\.com/i },
      { name: 'Heap', category: 'analytics', color: '#FF6D2E', icon: 'Hp',
        scriptMatch: /cdn\.heapanalytics\.com/i },
      { name: 'Plausible', category: 'analytics', color: '#5850EC', icon: 'Pl',
        scriptMatch: /plausible\.io\/js/i },
      { name: 'Fathom', category: 'analytics', color: '#9187FF', icon: 'Fa',
        scriptMatch: /cdn\.usefathom\.com|usefathom\.com/i },
      { name: 'Clarity', category: 'analytics', color: '#0078D4', icon: 'Cl',
        scriptMatch: /clarity\.ms/i },
      // Advertising
      { name: 'Google AdSense', category: 'advertising', color: '#4285F4', icon: 'AS',
        scriptMatch: /pagead2\.googlesyndication\.com|adsbygoogle/i },
      { name: 'Criteo', category: 'advertising', color: '#F27921', icon: 'Ct',
        scriptMatch: /static\.criteo\.net|criteo\.com/i },
      { name: 'Taboola', category: 'advertising', color: '#0054FF', icon: 'Tb',
        scriptMatch: /cdn\.taboola\.com/i },
      { name: 'Outbrain', category: 'advertising', color: '#EE5A24', icon: 'Ob',
        scriptMatch: /outbrain\.com|widgets\.outbrain\.com/i },
      { name: 'Amazon Ads', category: 'advertising', color: '#FF9900', icon: 'Az',
        scriptMatch: /amazon-adsystem\.com/i },
      { name: 'Mediavine', category: 'advertising', color: '#00B373', icon: 'Mv',
        scriptMatch: /scripts\.mediavine\.com/i },
      { name: 'AdThrive', category: 'advertising', color: '#56B4E9', icon: 'AT',
        scriptMatch: /ads\.adthrive\.com/i },
      // Tag Managers
      { name: 'Tealium', category: 'tag_manager', color: '#00A4BD', icon: 'Te',
        scriptMatch: /tags\.tiqcdn\.com|tealium/i },
      { name: 'Adobe Launch', category: 'tag_manager', color: '#EB1000', icon: 'AL',
        scriptMatch: /assets\.adobedtm\.com/i },
      { name: 'Segment', category: 'tag_manager', color: '#52BD94', icon: 'Sg',
        scriptMatch: /cdn\.segment\.com|segment\.io/i },
      { name: 'Ensighten', category: 'tag_manager', color: '#005BAA', icon: 'En',
        scriptMatch: /nexus\.ensighten\.com/i }
    ];
